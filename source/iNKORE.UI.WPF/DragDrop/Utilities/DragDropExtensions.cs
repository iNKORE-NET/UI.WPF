...
namespace iNKORE.UI.WPF.DragDrop.Utilities
{
    public static class DragDropExtensions
    {
        ...
        private static BitmapSource CaptureScreen(Visual target, FlowDirection flowDirection)
        {
            ...
            //DpiScale dpiScale = VisualTreeHelper.GetDpi(target);
            ...
            var dpiX = ScreenDpiHelper.DpiX;
            var dpiY = ScreenDpiHelper.DpiY;
            var dpiBounds = DpiHelper.LogicalRectToDevice(cropBounds, ScreenDpiHelper.ScaleX, ScreenDpiHelper.ScaleY);
